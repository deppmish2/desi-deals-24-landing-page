...
_A comprehensive toolbox for creating textual and image memes in Markdown-based blogs (MkDocs, Jekyll, Hugo, Astro, etc.)_
...
> >
> > > Person C: _concern intensifies_
```
...
_This notice has been automatically generated by the Department of Vibes._
```
...
_This incident report has been automatically generated by the Department of Preventable Disasters._
...
_also me next Friday:_ what could go wrong
...
_Want more deployment horror stories? Subscribe to our RSS feed of suffering._
