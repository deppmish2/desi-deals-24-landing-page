  ...
  return (
    ...
    >
      <div style={{ textAlign: "center", marginBottom: 24 }}>
        ...
        >
          Sign up free. Invite{" "}
          <strong style={{ color: T.textPrimary }}>1 friend</strong> who
          register and your full deals section unlocks — instantly.
        </p>
      </div>
              ...
              >
                <div
                  style={{
                    ...
                    height: 26,
                    borderRadius: "50%",
                    background: s.done ? T.brand : T.bgCard,
                    border: `2px solid ${s.done ? T.brand : T.brandMid}`,
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    fontSize: 11,
                    fontWeight: 800,
                    color: s.done ? T.textOnBrand : T.brandDark,
                    zIndex: 1,
                  }}
                >
                  {s.done ? "✓" : s.n}
                ...
                {i < arr.length - 1 && (
                  <div
                    style={{
                      width: 2,
                      height: 20,
                      background: `linear-gradient(to bottom, ${T.brandMid}, ${T.brandLight})`,
                      margin: "2px 0",
                    }}
                  />
                )}
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            >
              ...
              >
                Updated every morning at 08:00 hrs.
              </span>
            </div>
          </div>
        </div>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 48px" }}>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            >
              Live deals across 27 stores · refreshed every 24h
            </span>
          </div>
          <span style={{ fontSize: 12, color: T.brand, fontWeight: 600 }}>
            200+ deals unlock after 1 invite →
          </span>
        </div>
        <div
          style={{
        ...
        >
          ...
          <div
            style={{
              ...
              bottom: 4,
              width: 220,
              background: `linear-gradient(90deg,transparent,${T.bgCard})`,
              display: "flex",
              alignItems: "center",
  ...
  return (
    ...
    >
      ...
      >
        {!imgError && (
          <img
            src="https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=1600&q=85&fit=crop&crop=center"
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(to bottom,rgba(0,0,0,0.28) 0%,rgba(0,0,0,0.08) 40%,rgba(248,250,248,0.88) 78%,#F8FAF8 100%)",
          }}
        />
        <div
          style={{
        ...
        >
          <div>
            ...
            >
              ...
              >
                Indian groceries · 27 stores · All of Germany
              </span>
            </div>
            ...
            >
              ...
              >
                Discover the 24 best desi grocery deals across Germany — updated
                every day. We scan desi grocery stores across Europe and surface
                the 24 best deals of the day.
              </p>
            </div>
      ...
      >
        ...
        >
          {[
            {
              icon: "🏪",
              title: "Deals from 27 stores",
              sub: "Every live deal, aggregated daily",
            },
            {
              icon: "🔓",
              title: "Unlock with 1 invite",
              sub: "Invite 1 friend · deals section opens",
            },
          ].map((v, i, arr) => (
            <div
              key={i}
    ...
    <div style={{ minHeight: "100vh", background: T.bg }}>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          >
            {isPhone ? "💬 WhatsApp" : "🔵 Google"}
          </div>
        </div>
      </nav>

      <div
        style={{ maxWidth: 1060, margin: "0 auto", padding: "40px 40px 64px" }}
      >
        {/* ── Header ── */}
        <div style={{ marginBottom: 32 }}>
          {confirmedCount === 0 ? (
            <>
              ...
              >
                🔒 Deals locked · 2 registrations needed
              </div>
              <h1
                style={{
                  fontFamily: "'Fraunces',Georgia,serif",
              ...
              >
                You're in, <span style={{ color: T.brand }}>{displayName}</span>
                .<br />
                Now invite 1 friend. 🚀
              </h1>
              <p
                style={{ color: T.textSecondary, fontSize: 15, maxWidth: 560 }}
              >
                Your deals section is currently locked. The moment{" "}
                <strong style={{ color: T.textPrimary }}>
                  1 friend register
                </strong>{" "}
                using your link, it unlocks instantly.
              </p>
            </>
          ) : (
            <>
              ...
              >
                ⏳ Almost there · 1 more registration needed
              </div>
              <h1
                style={{
                  fontFamily: "'Fraunces',Georgia,serif",
              ...
              >
                <strong style={{ color: T.brand }}>
                  Priya just registered!
                </strong>{" "}
                You need one more friend to register and your full deals section
                unlocks.
              </p>
            </>
          )}
        ...
        >
          ...
          >
            ...
            >
              Share your link. Your friend signs up, enters your code — and
              that's it. The moment {INVITES_NEEDED} have registered, your deals
              section opens.
            </p>
          ...
          >
            ...
            >
              ...
              {mockPending.length > 0 && <> · {mockPending.length} pending</>}
            </p>
            ...
            {allInvites.length === 0 ? (
              <div style={{ flex: 1 }}>
                ...
                >
                  ...
                  >
                    Share your link on the left. As friends sign up they'll
                    appear here.
                  </p>
                </div>
                  ...
                  {[
                    {
                      initials: "P",
                      label: "Priya Sharma",
                      sub: "Registered via Google",
                      badge: "Registered",
                      badgeColor: T.brandDark,
                    ...
                    >
                      <div
                        style={{
                          ...
                          height: 34,
                          borderRadius: "50%",
                          background: i === 0 ? T.brandLight : T.bgMuted,
                          border: `1.5px solid ${i === 0 ? T.brandMid : T.border}`,
                          display: "flex",
                          alignItems: "center",
                          justifyContent: "center",
                          fontSize: 13,
                          fontWeight: 700,
                          color: i === 0 ? T.brandDark : T.textMuted,
                          flexShrink: 0,
                        }}
                      >
                        {row.initials}
              ...
              <>
                {allInvites.map((inv, i) => (
                  <InviteRow key={i} invite={inv} index={i} />
                ))}
                {mockPending.length > 0 && (
                  ...
                  >
                    ...
                    >
                      ⏳ {mockPending.length} friend
                      {mockPending.length > 1 ? "s" : ""} invited but not
                      registered yet
                    </div>
                    <div style={{ fontSize: 12, color: T.textSecondary }}>
                      Send them a reminder — they need to complete signup.
                    </div>
                  </div>
                )}
              </>
...
function DealsUnlocked({ identity }) {
  ...
  const filtered =
    filter === "all" ? ALL_DEALS : ALL_DEALS.filter((d) => d.tag === filter);
    ...
    <div style={{ minHeight: "100vh", background: T.bg }}>
        ...
        >
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <div style={{ fontSize: 13, color: T.brandMid }}>
              1 friend registered · your full deals section is now live
            </div>
          </div>
          <span style={{ fontSize: 28 }}>🎉</span>
        </div>
      ...
      >
        ...
        <div style={{ marginBottom: 28 }}>
          ...
          >
            Best prices across <span style={{ color: T.brand }}>27 stores</span>
            , live now.
          </h1>
          <p style={{ color: T.textSecondary, fontSize: 15, maxWidth: 520 }}>
            Deals refresh every 24h. Set alerts to get notified when your
            favourites drop in price.
          </p>
        </div>
          ...
          {[
            {
              label: "Live deals",
              value: "200+",
              sub: "across 27 stores",
              color: T.brand,
            },
            {
              label: "Avg. saving",
              value: "28%",
              sub: "vs. highest price",
              color: T.brand,
            },
            {
              label: "Stores live",
              value: "27",
              sub: "refreshed every 24h",
              color: T.blue,
            },
            {
              label: "Same-day avail",
              value: "14",
              sub: "stores in your postcode",
              color: T.brand,
            },
          ].map((s, i) => (
            <div
          ...
          {tags.map((t) => (
            <button
              ...
              style={{
                padding: "8px 18px",
                borderRadius: 99,
                border: `1px solid ${filter === t ? T.brand : T.border}`,
                background: filter === t ? T.brand : T.bgCard,
                color: filter === t ? T.textOnBrand : T.textSecondary,
                fontWeight: 600,
                fontSize: 13,
                cursor: "pointer",
                transition: "all 0.15s",
          ...
          {filtered.map((d, i) => (
            ...
            >
                    ...
                    color:
                      d.tag === "Flash deal"
                        ...
                        : d.tag === "Same-day"
                          ? T.blue
                          : T.brandDark,
                    border: `1px solid ${d.tag === "Flash deal" ? T.amberBorder : d.tag === "Same-day" ? "rgba(37,99,235,0.2)" : T.brandMid}`,
                  }}
                >
                  {d.tag}
                </div>
              ...
              <button
                ...
                onMouseEnter={(e) =>
                  (e.currentTarget.style.background = T.brandMid)
                }
                onMouseLeave={(e) =>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            ...
            <div>
              ...
              >
                Know more desi shoppers in Germany?
              </div>
              <div style={{ fontSize: 13, color: T.textSecondary }}>
                Share DesiDeals24 — every friend you bring in saves money on
...
export default function App() {
  ...
  useEffect(() => {
    const h = () => setView("landing");
    window.addEventListener("dd24back", h);
    return () => window.removeEventListener("dd24back", h);
  }, []);
