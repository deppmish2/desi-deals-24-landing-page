...
test("mapped-products: returns canonical with active deal", () => {
  ...
  db.exec(`INSERT INTO deals (id, crawl_run_id, crawl_timestamp, store_id, product_name, product_category, product_url, sale_price, is_active)
           VALUES ('d1', 'r1', '2026-01-01T00:00:00Z', 's1', 'Aachi Biryani Kit', 'Spices', 'https://jamoona.de/p1', 2.99, 1)`);
  db.exec(`INSERT INTO deal_mappings (deal_id, canonical_id, match_method) VALUES ('d1', 'cp1', 'auto')`);
...
test("mapped-products: store_count counts distinct stores", () => {
  ...
  db.exec(`INSERT INTO deal_mappings (deal_id, canonical_id, match_method) VALUES ('d1', 'cp1', 'auto'), ('d2', 'cp1', 'auto')`);
