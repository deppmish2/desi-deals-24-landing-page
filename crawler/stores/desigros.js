...
const STORE_ID = "desigros";
const STORE_NAME = "Desigros";
const STORE_URL = "https://www.desigros.com";
const UA =
...
async function scrape() {
  ...
  for (const handle of handles) {
    ...
    try {
      ...
      console.warn(`[desigros] ${handle}: ${e.message}`);
      continue;
    }
  ...
  console.log(`[desigros] Found ${deals.length} deals`);
  return deals;
}
